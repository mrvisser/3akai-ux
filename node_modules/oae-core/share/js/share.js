...
define(['jquery', 'oae.core'], function($, oae) {
    ...
    return function(uid) {
        ...
        var setUpAutoSuggest = function() {
            console.log('selected: %s', JSON.stringify(selectedResources, null, 2));
            ...
            console.log('contextProfile: %s', JSON.stringify(contextProfile, null, 2));

            // Initialize the autoSuggest field
            oae.api.util.autoSuggest().setup($('#share-autosuggest', $rootel), {
                'ghosts': ghosts,
                'scope': '_share',
                'resource': contextProfile,
